...
st.markdown(""" 
        ...
        <p>Predict <b> Tip Amount </b> from Total bill </b> using linear Regression</p>
        <div>
...
#Dataset Preview
st.markdown(f"""<div class="card"> <h3>Dataset Preview </h3>""",unsafe_allow_html=True)
...
st.markdown(f"""<div class="card"> <h3> Total bill vs Tip </h3>""",unsafe_allow_html=True)
...
st.markdown(f"""<div class="card"> <h3> Model Performance </h3>""",unsafe_allow_html=True)
